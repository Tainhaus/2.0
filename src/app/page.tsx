      ...
      <div className="container-site">
        <div className="bg-sand-200 rounded-4xl p-10 md:p-16 text-center relative overflow-hidden border border-sand-300">
          <div className="relative z-10">
            <p className="font-body text-xs font-semibold text-terracotta-500 uppercase tracking-[0.2em] mb-4">
              Start your journey
            </p>
            <h2 className="font-display text-2xl sm:text-3xl md:text-display-md text-charcoal-900 mb-4">
              Ready to transform
              <br />
              your outdoor space?
            </h2>
            <p className="font-body text-charcoal-600 max-w-xl mx-auto mb-8 leading-relaxed">
