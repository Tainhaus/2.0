...
const TESTIMONIALS = [
  {
    ...
    body: "I'm 67 and I use The Horizon every single morning as my reading room and art studio. It's the most peaceful space I've ever had. The installation team were absolute gentlemen â€” professional, tidy, and finished in a day. I tell everyone about Tainhaus.",
    author: "Margaret H.",
    age: "67",
  ...
  },
  {
    ...
    body: "The Studio with the sprung floor is genuinely better than the gym I was using. I do HIIT, pilates, and weights every morning. My partner does yoga in the evenings. It's paid for itself many times over in membership fees alone â€” let alone the time saved.",
    author: "Amanda W.",
    age: "52",
    use: "Home Gym",
    location: "Surrey",
  ...
  },
  {
    ...
    body: "I run a private yoga and sound healing practice from The Zenith. Six clients at a time, perfect acoustics, infrared heating, cork floor. It feels like a luxury studio. I've doubled my rates since getting it â€” my clients think I've found a new venue.",
    author: "Priya K.",
    age: "34",
    use: "Yoga Studio",
  ...
  },
  {
    id: 6,
    rating: 5,
    title: "The Nordic sauna in January â€” absolutely incredible",
      ...
      <div className="container-site relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="font-body text-sm text-forest-300 max-w-lg mx-auto">
            From 22 to 82 â€” our cabins are transforming lives across the UK.
          </p>
        </div>
