...
async function main() {
  ...
  await prisma.product.create({
    data: {
      ...
      description: "Immerse yourself in the modern elegance and comfort of the Santorini — a sleek retreat where contemporary design meets timeless charm. This spacious cabin is meticulously designed to provide a versatile space where you can relax, work, create, or entertain with flair.",
      longDescription: `The Santorini is our most spacious contemporary log cabin. Whether you envision it as a stylish garden office, a chic studio space, a cosy lounge area, or a welcoming guest suite, the Santorini is crafted to elevate your lifestyle and offer a luxurious haven amidst the serenity of nature.

Constructed with premium Nordic spruce logs grown in ecologically managed forests of Sweden, Finland and the Baltic States, every Santorini is built to last. The 44mm log walls provide excellent insulation, keeping the space warm in winter and cool in summer.
...
All products are packaged in UV-resistant plastic film and protected during transport. Installation plans are available for download upon purchase.`,
        ...
        create: [
          {
            ...
            body: "We had the Santorini installed as a home office and it's transformed how we work. Spacious, well insulated and looks beautiful in the garden. The installation team were brilliant.",
            authorName: "Sarah T.",
            authorAge: "38",
  ...
  await prisma.product.create({
    data: {
      ...
      description: "Unveil the perfect blend of elegance and tranquillity with the Maldives Log Cabin. This captivating cabin offers a harmonious fusion of traditional allure and modern sophistication, providing a serene oasis where relaxation and creativity intertwine seamlessly.",
      longDescription: `The Maldives is crafted from premium Nordic spruce wood, offering lasting durability and natural charm. Its generous dimensions of 4.7m × 3.2m provide ample room for various uses and configurations, from a reading nook or art studio to a meditation space or personal sanctuary.
...
Whether you envision it as a cosy retreat, an artistic studio, or a peaceful meditation space, the Maldives is meticulously crafted to enrich your outdoor experience and create a tranquil sanctuary for rejuvenation and inspiration.
...
All products are constructed using dry spruce grown in ecologically managed forests of Sweden, Finland, Russia or the Baltic States, packaged in UV-resistant plastic film and covered by our 5-year construction warranty.`,
      ...
      images: {
        create: [
          ...
          },
          {
            ...
            alt: "Maldives Log Cabin floor plan",
            isPrimary: false,
            order: 1,
          },
        ],
  ...
  await prisma.product.create({
    data: {
      ...
      description: "Introducing the Corsica Log Cabin from Northern Log Cabins, a stunning abode crafted from 100% Nordic high-quality spruce. Step into luxury and craftsmanship with this exquisite log cabin featuring extra-dry laminated timber windows and doors.",
      longDescription: `The Corsica is built from 100% Nordic high-quality spruce — the same material used in premium Scandinavian construction for centuries. Extra-dry (8–12% moisture content) laminated timber windows and doors resist warping and ensure a perfect fit year after year.
...
Ideal as a serene home office, cosy guest accommodation, tranquil reading nook, or artist's studio, the Corsica is a versatile space that will enhance your garden for decades. Covered by our 5-year construction warranty and packaged in UV-resistant plastic film for safe delivery.`,
      price: 11400,
      category: "LOG_CABIN",
        ...
        create: [
          {
            ...
            body: "Absolutely love the Corsica. The windows are a real highlight — they open both ways and let in so much air. Well made and straightforward to put up.",
            authorName: "Mike D.",
            authorAge: "41",
            authorUse: "Home Office",
            verified: true,
...
Comes with nails, screws, and detailed installation instructions for straightforward DIY assembly.`,
  ...
  await prisma.product.create({
    data: {
      ...
      description: "Introducing the Capri Log Cabin — a retreat crafted from 100% Nordic high-quality spruce. Featuring doors and windows made from extra-dry laminated timber with just 8–12% moisture content, this elegant cabin combines beauty with long-lasting durability.",
      longDescription: `The Capri is proof that you don't need a large garden to enjoy a premium log cabin. At just 4.5m × 2.0m, it fits neatly into smaller gardens and patios while delivering the same quality construction as our larger models.
...
Covered by our 5-year construction warranty from the date of purchase. All products are packaged in UV-resistant plastic film for protection during delivery and storage.`,
      ...
      images: {
        create: [
          ...
          {
            url: "/products/gloria-h-4-5x2-9m-log-cabin-oak.png",
            alt: "Capri Log Cabin floor plan",
            isPrimary: false,
            order: 1,
          },
        ],
        ...
        create: [
          {
            ...
            body: "We have a terrace garden so space is limited. The Capri fits perfectly and looks lovely. Great quality for the price — warm, dry and well made.",
            authorName: "Anna K.",
            authorAge: "35",
  ...
  await prisma.product.create({
    data: {
      ...
      description: "Introducing the Bermuda Log Cabin from Northern Log Cabins — your go-to choice for versatile outdoor living and storage solutions. Crafted with 44mm Spruce double T&G wall logs, this cabin combines a comfortable 7.617m² cabin area with a practical 3.907m² storage section.",
      longDescription: `The Bermuda is built for those who want a proper multi-purpose outdoor building. The clever design combines a comfortable, insulated living or working space of 7.617m² with a 3.907m² storage area — all within a 4.5m × 3m footprint.
...
Comes complete with nails, screws, and detailed installation instructions, making assembly straightforward for the DIY enthusiast. Covered by our 5-year construction warranty.`,
        ...
        create: [
          {
            ...
            alt: "Bermuda 4.5m x 3m Log Cabin exterior",
            isPrimary: true,
            order: 0,
          },
        ],
        ...
        create: [
          {
            ...
            body: "The Bermuda is spot on. I use the main cabin as a woodworking workshop and the storage section for all my timber and materials. Solid, well insulated and very good looking.",
            authorName: "David R.",
            authorAge: "58",
  ...
  await prisma.product.create({
    data: {
      ...
      description: "Experience luxury living with the Bali 2 Bed Log Cabin. This exceptional cabin combines elegance and functionality, offering a spacious retreat that embodies contemporary design and comfort.",
      longDescription: "The Bali 2 Bed Log Cabin is built with 70mm thick triple tongue and groove logs sourced from Finland. Two well-appointed bedrooms make this cabin ideal as a permanent residence, a holiday retreat, or a premium guest annexe.\n\nEvery Bali comes with 100mm insulation in both floor and roof. Premium double-glazed doors and windows are available in any colour, and pre-drilled logs allow electrical cables to be concealed.\n\nBacked by our 5-year structural warranty. Call us for pricing on this bespoke product.",
      price: 62200,
      category: "LOG_CABIN",
