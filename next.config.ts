...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=(self)" },
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://js.stripe.com",
...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      ...
      { protocol: "https", hostname: "www.tainhaus.co.uk" },
    ],
  },
  async headers() {
    return [
